class Converter {
    ...
    public static int converterToArabian(String romanNumeral) {
        return switch (romanNumeral) {
            ...
            case "IX": yield 9;
            case "X": yield 10;
            default: throw new IllegalArgumentException("Необходимо ввести цифру от I до X");
        };
    }
    public static String converterToRoman(int number) throws IllegalArgumentException {
        if (number < 1) {
